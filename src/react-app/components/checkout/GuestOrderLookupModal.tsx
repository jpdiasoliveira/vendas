...
import {
  guestEmailOk,
  guestOrderStatusColor,
  guestOrderStatusText,
  orderIdOk,
} from "@/react-app/utils/guestOrderLookup";
          ...
          >
            ...
            <>
              ...
              <div className="mb-4 flex flex-wrap items-center gap-2">
                <span
                  className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-bold ${guestOrderStatusColor(order.status)}`}
                >
                  {guestOrderStatusText(order.status)}
                </span>
